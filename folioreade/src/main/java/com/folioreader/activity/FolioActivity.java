...
public class FolioActivity extends AppCompatActivity implements
    ...
    private boolean isAddOld,isAddNew;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isAddOld = getIntent().getBooleanExtra("isAdd",false);
        isAddNew = isAddOld;
        ...
        final ImageView shoucang = (ImageView) findViewById(R.id.btn_speaker);
        shoucang.setImageResource(isAddNew?R.drawable.btn_sc_pre:R.drawable.btn_sc);
        shoucang.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(isAddNew){
                    shoucang.setImageResource(R.drawable.btn_sc);
                }else{
                    shoucang.setImageResource(R.drawable.btn_sc_pre);
                }
                isAddNew = !isAddNew;
//                if (mIsSmilParsed) {
...
//                }
    ...
    public void onBackPressed() {
        saveBookState();
        if(isAddNew != isAddOld){
            Intent intent = new Intent();
            intent.putExtra("isAdd",isAddNew);
